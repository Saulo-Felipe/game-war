import { steveAnimation } from './Animations'


export default function Steve(scene) {
	steveAnimation(scene)
  ...
  this.bullets.createMultiple({
    ...
    if (this.sprite.body.onFloor())
      if (this.property.isShooting)
        this.sprite.play("steve-run-shoot", true)
      else
  			this.sprite.play("steve-run", true)

		else
      if (this.property.isShooting)
        this.sprite.play("steve-jump-shoot", true)
      else
        this.sprite.play("steve-jump", true)
	...
	this.moveStopped = () => {
		...
		if (this.sprite.body.onFloor()) {
      if (this.property.isShooting)
        this.sprite.play("steve-stopped-shoot", true)
      else
        this.sprite.play("steve-stopped", true)
